...
public class TextAnalyzer {
	...
	private static final HashSet<String> STOP_WORDS = new HashSet<String>() {{
		...
		add("call"); add("can"); add("cannot"); add("cant"); add("change"); add("co"); add("con"); add("convert"); add("could"); add("couldnt"); 
		add("de"); add("describe"); add("detail"); add("do"); add("done"); add("down"); add("due"); add("during"); add("dynamic");
		...
		add("everywhere"); add("except"); add("example"); add("few"); add("fifteen"); add("fify"); add("fill"); add("find"); 
		add("fire"); add("first"); add("five"); add("for"); add("former"); add("formerly"); add("forty"); 
		add("found"); add("four"); add("from"); add("front"); add("full"); add("further"); add("get"); add("generate"); add("give");
		...
		add("keep"); add("labview"); add("last"); add("latter"); add("latterly"); add("least"); add("less"); add("ltd"); add("made");
		...
		add("nowhere"); add("object"); add("of"); add("off"); add("often"); add("on"); add("once"); add("one"); add("only"); 
		...
		add("please"); add("program"); add("programatic"); add("programmatic"); add("put"); add("rather"); add("re"); add("same"); add("see"); add("seem"); add("seemed");
		...
		add("someone"); add("something"); add("sometime"); add("sometimes"); add("somewhere"); add("stop"); add("still"); add("such"); add("switch");
		...
		add("two"); add("un"); add("under"); add("until"); add("up"); add("upon"); add("us"); add("use"); add("very"); add("via"); 
...
//		}
	...
	public List<String> filterStopWords(List<String> worlds) {
//		Iterator<String> iterator = worlds.iterator();
//		while(iterator.hasNext()) {
//			String word = iterator.next();
//			if (STOP_WORDS.contains(word)) {
...
//			}
	...
	public List<String> analyze(String source) {
		...
		return filterStopWords(stemmed);
	}
